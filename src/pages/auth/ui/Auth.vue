...
<template>
    <div class="flex items-center justify-center min-h-screen">
        <Card class="w-[350px]">
            ...
            <Form :validation-schema="formSchema" @submit="onSubmit">
                <div class="grid items-center w-full gap-4">
                    <div class="flex flex-col space-y-1.5">
                        ...
                        <Field name="username" type="text" class="border rounded-md h-8" />
                        <ErrorMessage name="username" class="text-red-500" />
                    </div>

                    <div class="flex flex-col space-y-1.5">
                        <Label for="password">Password</Label>
                        <Field name="password" type="password" class="border rounded-md h-8" />
            ...
            <CardFooter>
                <Button type="button" variant="outline" @click="isRegistration = !isRegistration">
                    <template v-if="isRegistration">
                        Login
                    </template>
                    <template v-else>
